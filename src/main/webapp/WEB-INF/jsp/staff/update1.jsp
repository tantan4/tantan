...
<div class="modal-dialog modal-lg" role="document" id="you">
		<div class="modal-content" id="my">
			<div class="modal-header">
		        ...
		        <h4 class="modal-title" id="staffModalLabel">更新员工</h4>
		    </div>
		    
   			<div class="modal-body">
   				<form role="form" id="staffUpdateForm" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">姓&nbsp;&nbsp;&nbsp;名</label>
                        <div class="col-sm-10">
                        <input class="form-control"  name="id" value="${staff.id }" type="hidden">
                    ...
                    <div class="form-group">
                        ...
                        <label class="radio-inline">
                            <input type="radio" value="<%=d.getValue()%>" <% if (d.getSelected()) {%>checked="checked"<%} %>  name="gender"> <%=d.getName()%>
                        </label>
                        <% } %>
                        </div>
                    </div>
                    <%-- <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <input class="form-control" name="birthday" type="datetime-local" value="${staff.birthday }">
                        </div>
                    </div> --%>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">生&nbsp;&nbsp;&nbsp;日</label>
                       ...
                       <div class="col-sm-10">
                        <input size="16" class="form-control" type="data" name="birthday" value="${staff.birthday }" readonly>
				...
				<div class="form-group ">
				 <label class="col-sm-2 control-label">职&nbsp;&nbsp;&nbsp;位</label>
					 ...
					 <input type="text" class="form-control" id="staffFormPositionNames" value="${staff.positionNames }"> 
	...
	function selectStaffPositions () {
		...
		$('#staffDialog1').load ('${pageContext.request.contextPath}/staff/positions');
		 ...
		 $(document).ready(function () {	
	   			$('#staffUpdateForm').bootstrapValidator({
	   			...
	   			// $('#staffUpdateForm').data('bootstrapValidator').enableFieldValidators('roleIds', false);
		    });
	    
		   	function submitStaffUpdateForm () {
				// 获取关联的bootstrapValidator对象	
		   		var bv = $('#staffUpdateForm').data('bootstrapValidator');
		        bv.validate();
		        if (!bv.isValid()) {
		        	return;
		        }
