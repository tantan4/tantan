    ...
    <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
		        ...
		        <h4 class="modal-title" id="deptModalLabel">创建部门</h4>
		    </div>
            ...
            <!--<div class="row">
                ...
                <script type="text/javascript">
                	function submitCreateForm () {
                		var url = '${pageContext.request.contextPath}/dept/create';
                		$.post (url, $('#deptCreateForm').serializeArray(), function (result) {
                			if (result.success) {
                				/* location.reload (); */
                				 $('#page-wrapper').load ('${pageContext.request.contextPath}/dept');
