   			...
   			<div class="modal-body">
   				<form role="form" id="userUpdateForm" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        	<input class="form-control" name="id" value="${user.id}" readonly="readonly" id="idId">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">登录名</label>
                        <div class="col-sm-10">
                        	<input class="form-control" placeholder="请输入登录名" name="loginName" value="${user.loginName }" id="loginId">
                        </div>
                    </div>
                   	<div class="form-group">
                        <label class="col-sm-2 control-label">姓名</label>
                        <div class="col-sm-10">
                        <input class="form-control" placeholder="请输入姓名" name="name" value="${user.name }">
                        </div>
                    </div>
                    <div class="form-group">
   		...
   		$(document).ready (function () {
   		 $("#loginId").blur(function() {
				...
				$.post('${pageContext.request.contextPath}/user/loginname', {
					'loginName' : loginname,'id':loginid
				}, function(result) {
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="userUpdateForm">
                                        ...
                                        <div class="form-group">
                                            <label>登录名</label>
                                            <input class="form-control" placeholder="请输入登录名" name="loginName" value="${user.loginName }">
                                        </div>
                                       	<div class="form-group">
                                            <label>姓名</label>
                                            <input class="form-control" placeholder="请输入姓名" name="name" value="${user.name }">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="checkbox-inline">
                                                <input type="checkbox" value="<%=r.getId()%>" name="roleIds" <% if (r.getSelected()) {%>checked="checked"<%} %> ><%=r.getName()%>
                                            </label>
                                            <% } %>
                                        </div>
                                        <button type="button" class="btn btn-default" onclick="submitUserUpdateForm ();">提交</button>
